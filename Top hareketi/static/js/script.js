...
function generateRandomStartEnd() {
...
function updateBallPosition() {
    ...
    ball.style.top = ballY + "px";
     ...
     // Bitiş pozisyonunu kontrol et ve oyunu bitir
     if (ballX === endCol * 100 && ballY === endRow * 100) {
        // Oyunu bitirme mantığını burada ekleyin
...
while (true) {
    ballX = Math.floor(Math.random() * (COLS * 100));
    ballY = Math.floor(Math.random() * (ROWS * 100));
